...
| 路线 | 已有上下文，但没有好思路或需要 agent 给路线 | `prompts/zh-CN/04-route-without-user-idea.md` |
...
- `rules/global-agent-rules.zh-CN.md`：全局 agent 规则模板，适合放进 Codex / Claude Code / Cursor 等工具的全局规则。
- `rules/generate-project-agent-rules.zh-CN.md`：项目级规则生成 Prompt，让 Codex、Claude Code 或其他 AI coding agent 读取当前仓库，并生成 `AGENTS.md`、`CLAUDE.md` 或等价规则文件。
